...
export default defineConfig({
  testDir: "./e2e",
  testMatch: ["ios-device-matrix.spec.ts", "auth-recovery.spec.ts", "session-recovery.spec.ts", "apple-signin.spec.ts", "account-accessibility.spec.ts", "capture-reliability.spec.ts", "library-paging.spec.ts", "chat-transcript-scroll.spec.ts"],
  timeout: 60_000,
