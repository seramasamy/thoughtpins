...
from thoughtpins.chat import reply as _chat_reply
...
build_conversation_memory_context = _chat_reply.build_conversation_memory_context
...
def generate_conversation_reply(
    ...
    *,
    ...
    """Apply Telegram's size boundary and cache path to the shared reply."""
    return _chat_reply.generate_conversation_reply(
        text,
        chat_id=chat_id,
        user_id=user_id,
        session=session,
        ...
        trim=_trim_for_telegram if trim_for_telegram else None,
        persist=_save_conversation_cache,
    )
