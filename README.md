...
[![Tests](https://img.shields.io/badge/tests-672-587465)](tests/)
...
Backed by **672 tests**, **28 machine-enforced quality gates**, and CI across Python,
...
tests/                672 tests across 111 files
